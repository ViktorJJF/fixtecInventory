  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "ReportSales",
        component: () => import("@/views/drawerPages/ReportSales.vue"),
      },
      {
        path: "/reporte-de-ventas-servicios",
        name: "ReportSalesServices",
        component: () => import("@/views/drawerPages/ReportSalesServices.vue"),
      },
      {
